...
var Ledgerbitbull = function(comm) {
	this.comm = comm;
	this.comm.setScrambleKey('w0w');
}

Ledgerbitbull.prototype.getAddress_async = function(path) {
...
Ledgerbitbull.prototype.signTransaction_async = function(path, rawTxHex) {
	var splitPath = utils.splitPath(path);
...
Ledgerbitbull.prototype.getAppConfiguration_async = function() {
...
Ledgerbitbull.prototype.signPersonalMessage_async = function(path, messageHex) {
	var splitPath = utils.splitPath(path);
	var offset = 0;
